...
class Gallery extends Component {
  ...
  render() {
    ...
    const {imageUrl, imageAltText} = imagesList[initialImage]
    return (
          ...
          <ul className="thumbnail-list-container">
            {imagesList.map(eachImage => (
              <ThumbnailItem
                ...
                key={eachImage.id}
                clickedOnImage={this.clickedOnImage}
                isImageActive={initialImage === eachImage.id}
              />
            ))}
          </ul>
        </div>
